...
//            val displayName = displayName(call.remoteAddress)
...
//            if ((address.displayName?.contains("CTC") == true) || (address.displayName?.contains("*8") == true)) {
//                return address.displayName.toString()
//            }
//
//            return ContactListHolder.getCompanyByPhone(address.username!!)?.name ?: ContactListHolder.getLocalByPhone(address.username!!)?.name ?: LinphoneUtils.getDisplayName(address)
//        }
//
